...
export const products = [
  ...
  },
  {
    ...
    name: 'Alabaster Ceiling',
    category: 'Ceiling',
    image: imgAlabasterCeiling,
    gallery: [imgAlabasterCeiling],
    short: 'Soft-glow alabaster ceiling panels for a premium, backlit look.',
    description:
      'Alabaster ceiling panels create a smooth, milky surface that glows beautifully with backlighting. A signature choice for lobbies, showrooms and modern homes.',
    features: ['Soft, natural glow', 'Works with backlighting', 'Seamless large panels', 'Premium modern finish'],
