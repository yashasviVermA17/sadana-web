...
export const products = [
  ...
  make({
    ...
    gallery: [imgWallPaneling, imgHdhmr, img3DPanels],
  ...
  make({
    ...
    category: 'Wall Finishes',
    image: imgParametric,
    gallery: [imgParametric, imgParametric1, imgWallPaneling, img3DPanels],
  ...
  make({
    ...
    gallery: [imgHighlightSheet, imgAcrylicSheetOld, imgHighlighterSheet2, imgCharcoalHighlighter],
  ...
  make({
    ...
    category: 'Ceilings',
    image: imgBaffle,
    gallery: [imgBaffle, imgPvcCeilingJpeg, imgStretchFiber, imgVoxSoffit],
  ...
  make({
    ...
    gallery: [imgGymFlooring, imgWoodenFlooring, imgVinylFlooring, imgSpcFlooring],
  ...
  make({
    ...
    image: imgDoors,
    gallery: [imgDoors, imgWallPaneling],
  ...
  make({
    ...
    category: 'Doors & Panels',
    image: imgLaminates,
    gallery: [imgLaminates, imgLaminateSheet],
  ...
  make({
    ...
    gallery: [imgExteriorCladding, imgExteriorCladdingJpeg, imgWallCladding],
  ...
  make({
    ...
    category: 'Exterior & Outdoor',
    image: imgWpcPanels,
    gallery: [imgExteriorVoxPanel, imgHdpcLouvers, imgCharcoalLouvers],
  ...
  make({
    ...
    gallery: [imgCharcoalLouvers, imgExteriorLouvers, imgWallCladding, imgHdpcLouvers],
  ...
  make({
    ...
    category: 'Wall Finishes',
    image: imgHdhmr,
    gallery: [imgHdhmr, img3dWallPanelJpg, img3DPanels, imgWallPaneling],
  ...
  make({
    ...
    gallery: [imgVeneerSheets, imgPlywoodJpeg],
  ...
  make({
    ...
    gallery: [imgWoodenBlinds, imgBlinds],
  ...
  make({
    ...
    gallery: [imgArtificialGrass, imgArtificialGrass1, imgExteriorCladding],
  ...
  make({
    ...
    category: 'Exterior & Outdoor',
    image: imgExteriorCladding,
    gallery: [imgExteriorCladding, imgExteriorCladdingJpeg, imgArtificialGrass1],
