...
export default function About() {
  return (
    <>
      <section data-hero className="relative h-[50vh] min-h-[300px] w-full overflow-hidden sm:h-[52vh] sm:min-h-[360px] lg:h-[100vh] lg:min-h-[720px]">
        <img
          src={imgHero}
          alt=""
          aria-hidden="true"
          className="absolute inset-x-0 top-0 block h-full w-full object-cover object-top lg:object-[center_40%]"
        />
